...
const actionData = {
  proactive: [
    { name: "Attack", tags: ["melee", "ranged"], desc: `The character can attempt to strike an opponent using a hand-to-hand or ranged weapon. As movement takes place after performing an action, attackers will have to be strategic when closing with an opponent. 
      <br/><br/>
    ...
    { name: "Regain Footing", tags: ["movement"], desc: `If unengaged with an opponent, characters can automatically regain their footing from being tripped or knocked down. A prone yet engaged character may attempt a kick-up manoeuvre, kicking up from prone to standing with a Standard Acrobatics roll. A failed roll leaves the character prone. 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may move at a gait no faster than a Walk.` },
    { name: "Struggle", tags: ["melee"], desc: `If the victim of a certain types of attack or Special Effect, the character may attempt to disengage from the situation, for example, breaking free from a Grapple or Pin Weapon. 
      <br/><br/> 
  ...
  free: [
    { name: "Assess Situation", tags: ["general"], desc: `If unengaged, a character can make a Perception roll at no Action Point cost. A Success reveals any relevant changes in the tactical situation (such a spotting a foe beginning a charge). 
      <br/><br/>
    ...
    { name: "Change Facing", tags: ["movement"], desc: `As a free action, after the results of an attack are applied, the defender may change facing to better defend against any further strikes. 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may be moving at a gait no faster than a Walk.` },
    { name: "Drop Weapon", tags: ["general"], desc: `Dropping a weapon is a Free Action. 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may be moving at a gait no faster than a Run.` },
    { name: "Signal", tags: ["general"], desc: `If unengaged, gesturing or signalling to one or more participants (as long as they can perceive the sign) is a Free Action. 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may be moving at a gait no faster than a Walk.` },
    { name: "Speak", tags: ["general"], desc: `A character can speak at any time during combat, but what is said should be limited to short phrases that can be uttered in 5 seconds or less, for example, 'Time to die!', 'Look out behind you!' or 'Long live Gygax!' 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may be moving at a gait no faster than a Run.` },
    { name: "Use Luck Point", tags: ["general"], desc: `Using a Luck Point - to re-roll a particular result, for example - is a Free Action. 
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character suffers no movement restrictions.` },
    { name: "Ward Location", tags: ["melee"], desc: `The character guards a particular Hit Location from being hit by dedicating one weapons to statically cover the area. Any blow that lands on that location has its damage automatically downgraded as per normal for a parrying weapon of its SIZ. The ward continues until the dedicated weapon is used to attack or actively parry. Establishing a ward or changing the Hit Location covered must be performed prior to an opponent rolling to attack the character. Due to their design, shields can cover multiple areas. For further explanation, see Passive Blocking in MYTHRAS.
      <br/><br/>
      <strong>Movement Restrictions</strong>: The character may be moving at a gait no faster than a Run.` }
  ]
};
...
function buildActionHTML(actionList) {
  return actionList.map(action => `
    <details class="action-pill" data-name="${action.name}" data-desc="${action.desc}" data-tags="${action.tags.join(' ')}">
